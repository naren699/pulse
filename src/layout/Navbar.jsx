        ...
        <div className="flex items-center gap-2">
          ...
          <Link to="/dashboard" className="flex items-center gap-2 md:hidden">
            <svg viewBox="0 0 64 64" width="22" height="22" aria-hidden="true">
              <path d="M8 34h12l5-14 8 26 6-18 4 6h13" fill="none" stroke="#9d8fff" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <div className="relative" ref={menuRef}>
            <motion.button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-primary via-secondary to-accent font-display text-sm font-bold text-white shadow-[0_0_20px_-4px_rgba(168,85,247,0.7)]"
              ...
              {menuOpen && (
                ...
                >
                  ...
                  <button
                    ...
                    className="mt-1.5 flex w-full items-center gap-2.5 rounded-xl px-3 py-2.5 text-sm text-text-secondary transition-colors hover:bg-danger/15 hover:text-[#ff9fb0]"
                  >
