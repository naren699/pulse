export function Field({ label, error, helper, children }) {
  return (
    <div className="mb-4">
      ...
      {children}
      {error ? (
        <p className="mt-1.5 animate-fade-slide-up text-xs font-medium text-[#ff8fa3]">⚠️ {error}</p>
      ) : helper ? (
...
const errorRing = 'border-danger/50 bg-danger/[0.06] shadow-[0_0_0_3px_rgba(255,94,120,0.12)]'
