    ...
    <div className="relative overflow-hidden py-16 text-center">
      ...
      >
        <motion.div
          ...
          className="mx-auto mb-5 flex h-[72px] w-[72px] items-center justify-center rounded-3xl border border-primary/30 bg-bg-primary/80 shadow-[0_0_64px_rgba(124,108,255,0.45)] backdrop-blur-xl"
        >
