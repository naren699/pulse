...
import { addTask, updateTask, toggleTask, deleteTask } from '../services/taskService'
    ...
    <div className="card-glass group flex items-center gap-3 p-4 transition-all hover:border-primary/20">
      <button
        ...
        className={[
          ...
          task.done
            ? 'scale-105 border-cyan bg-gradient-to-br from-cyan to-blue text-bg-dark shadow-[0_0_14px_rgba(34,211,238,0.5)]'
            : 'border-white/25 hover:border-cyan hover:shadow-[0_0_12px_rgba(34,211,238,0.35)]',
        ].join(' ')}
      >
...
export default function TasksPage() {
  ...
  return (
    <div className="hero-spot mx-auto max-w-[800px]" style={{ '--accent': '#22d3ee' }}>
