...
import { attendanceStatus, classesRemaining } from '../services/attendanceService'
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-5">
        <ProgressRing percent={stats.percentage} size="md" from="#3b82f6" to="#22d3ee" />
      ...
      <div className="mt-5 flex gap-3">
        ...
        <button
          ...
          className="flex-1 rounded-xl border border-danger/30 bg-danger/[0.12] px-4 py-2.5 font-display text-sm font-semibold text-[#ff9fb0] transition-all duration-300 hover:-translate-y-0.5 hover:bg-danger/25 hover:shadow-[0_10px_32px_-8px_rgba(255,94,120,0.45)] active:scale-[0.98]"
        >
          ✗ Absent
        </button>
      </div>
