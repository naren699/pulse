...
export default function PostHackathonModal({ isOpen, onClose, onSubmit }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Post New Hackathon" maxWidth="max-w-[560px]">
      <form onSubmit={handleSubmit}>
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <Button type="submit" loading={saving}>Post Hackathon</Button>
        </div>
      </form>
    </Modal>
  )
