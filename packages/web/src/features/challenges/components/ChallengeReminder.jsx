...
import { toDateId } from '@pulse/shared/utils'
...
export default function ChallengeReminder() {
  ...
  return (
    <div className="mb-6 flex flex-wrap items-center gap-3 rounded-xl border border-warning/25 bg-warning/10 px-5 py-3.5 animate-slide-down-in">
