...
import { useAttendance, useSubjectSessions } from '@pulse/shared/hooks'
import { markAttendance, clearAttendance } from '@pulse/shared/services'
...
export default function MonthlyReportPage() {
  ...
  return (
    <div className="hero-spot mx-auto max-w-[720px]" style={{ '--accent': '#8b5cf6' }}>
      <div className="mb-6">
